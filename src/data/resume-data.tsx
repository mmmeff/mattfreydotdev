...
export const contactLinks = [
    ...
    {
        href: "mailto:iam@mattfrey.dev",
        label: "iam@mattfrey.dev",
        icon: <FaEnvelope />,
    },
];
...
export const experience: ExperienceItem[] = [
    {
        ...
        endDate: "present",
        responsibilities: [
            "Started and now leading the design and implementation of Boltline (previously named Fusion by STOKE), a SaaS product that solves inventory tracking and work management in the hardware space.",
            "Full-stack Typescript development of the entire platform, including a Prisma-powered GraphQL API and a Next.js front-end",
            "Coaching and mentoring engineers on the team as we tackle an ambiguous problem space",
            "Designing, building, and maintaining infrastructure on AWS GovCloud, CI/CD, end-to-end testing, and operational observability",
...
export const projects: ProjectItem[] = [
    {
        name: "Boltline",
        employer: "Stoke Space Technologies",
        year: "2022+",
        description: `
            Boltline is a SaaS product that solves inventory, work management, and
            compliance in the hardware space, dogfooded internally at Stoke as it develops
            the world's most rapidly reusable rocket. 
            As the first hire on the team, I started and have lead this project since 2022, 
            and have been responsible for the design and implementation of the entire platform,
            from both a product and infrastructure perspective.
        `,
        link: "https://www.boltline.com",
    },
    {
        name: "IMDbNext",
        employer: "IMDb.com",
